...
WORKDIR /fzweb
RUN /fzweb/fuzion/build/bin/fz -classes -JLibraries="wolfssl sodium" -verbose=2 -debug=0 -modules=http,lock_free,uuid,mail,wolfssl,crypto,sodium,nom,web -sourceDirs=src run
